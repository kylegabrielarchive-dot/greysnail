...
def jovan():
    ...
    {green} 
           ...
           ██║░░██║██████╔╝██║░╚═╝░██║██║██║░╚███║██████╔╝
          ╚═╝░░╚═╝╚═════╝░╚═╝░░░░░╚═╝╚═╝╚═╝░░╚══╝╚═════╝░
                 {white} https://greysnail.site
     {red}──────────────────────────────────────────────────────────────────────\033[0m
     {red}OWNER     {white}: {yellow} Gabriel Nocturne
     {red}FACEBOOK  {white}: {yellow} Gabriel Nocturne
     {red}──────────────────────────────────────────────────────────────────────\033[0m""")
...
def jovan():
    ...
    print(f"""
{PL}┌──────────────────────────────────────────────────────────────────────────┐
{PL}│  👑 Author : Gabriel.                     💵 Tools : Paided              {PL}   │
{PL}│  🗓️  Build Date : Nov.                 🍄 Premium Tools                {PL}   │
{PL}│  🚀 Version : 1.7.5                   🚥 Status : Active              {PL}   │
{PL}│  📂 Uses : Boosting                   📶 Connection : Wifi / Data       {PL} │
{PL}│                                                                        {PL}  │
{PL}│ {BG1}      {PL} W E L C O M E  T O   G A B R I E L     B O O S T I N G  T O O L S    {RW}   {PL}│
{PL}└──────────────────────────────────────────────────────────────────────────┘""")
...
def main():
    ...
    print(f"                      """)
    print(f"""{PL}┌──────────────────────────────────────────────────────────────────────────┐
{PL}│   🗂️ Total of {Z1}FRA{white} ACCOUNT Stored  : {total_accounts}                                  {PL}   │
{PL}│   🗂️ Total of {Z1}FRA {white}PAGE  Stored    : {total_pages}                                    {PL} │
{PL}│   🗂️ Total of {yellow}RPW {white}ACCOUNT Stored  : {total_account_rpw}                                    {PL} │
{PL}│   🗂️ Total of {yellow}RPW {white}PAGE Stored     : {total_pages_rpw}                                    {PL} │
{PL}│                                                                     {PL}     │
{PL}└──────────────────────────────────────────────────────────────────────────┘""")
    print(f" {PL}╭────────────────────────────────────────────────────────────────────────╮")                   
    print(f" {PL}│                  {PL}𝗝 𝗔 𝗖 𝗘  𝗕 𝗢 𝗢 𝗦 𝗧 𝗜 𝗡 𝗚  𝗧 𝗢 𝗢 𝗟 𝗦                 {PL}  │")
    print(f" {PL}╰────────────────────────────────────────────────────────────────────────╯ """)
    print(f"                {PL} │            {PL}𝗔𝗖𝗖𝗢𝗨𝗡𝗧 𝗦𝗧𝗔𝗧𝗨𝗦             {PL} │ ")
    print(f"                {PL} ╰────────────────────────────────────────╯")
    print(f"    {PL}╭───────────────────────╮")
    print(f"    {PL}│   {BG1} {A} STORED ACCOUNT {RW} {PL}  │──── [{BG2}{A} 01/A {RW}]──── {red}◉ {yellow}◉ {green}◉  {Q6}ACCOUNT EXTRACTION ")
    print(f"    {PL}╰───────────────────────╯")
    print(f"   {PL} ╭───────────────────────╮")
    ...
    print(f"{PL} ╰────────────────────────────────────────────────────────────────────────╯ """)
    print(f"   {PL} ╭───────────────────────╮")
    print(f"    {PL}│   {BG1} {A} REACTION V1 {RW}   {PL}   │──── [{BG2}{A} 03/C {RW}]──── {red}◉ {yellow}◉ {green}◉  {Q6} PAGE OR ACCOUNT ")
    print(f"    {PL}╰───────────────────────╯")
    print(f"    {PL}╭───────────────────────╮")
    print(f"   {PL} │   {BG1} {A} PHOTO / VIDEO  {RW}   {PL}│──── [{BG2}{A} 04/D {RW}]──── {red}◉ {yellow}◉ {green}◉  {Q6} PAGE OR ACCOUNT ")
    print(f"    {PL}╰───────────────────────╯")
    print(f" {PL}╭────────────────────────────────────────────────────────────────────────╮")                   
    print(f" {PL}│                    {PL} 𝗦 𝗛 𝗔 𝗥 𝗘   𝗕 𝗢 𝗢 𝗦 𝗧 𝗜 𝗡 𝗚                      {PL}  │")
    print(f" {PL}╰────────────────────────────────────────────────────────────────────────╯ """)
    print(f"    {PL}╭───────────────────────╮")
    print(f"   {PL} │   {BG1} {A} SHARE V1.1  {RW}      {PL}│──── [{BG2}{A} 05/E {RW}]──── {red}◉ {yellow}◉ {green}◉ {Q6} BOT ( FAST PROCESS ) ")
    print(f"    {PL}╰───────────────────────╯")
    print(f"    {PL}╭───────────────────────╮")
    print(f"   {PL} │   {BG1} {A} SHARE V2.1 {RW}      {PL} │──── [{BG2}{A} 06/F {RW}]──── {red}◉ {yellow}◉ {green}◉ {Q6}MONITIZABLE (ACCURATE )  ")
    print(f"   {PL} ╰───────────────────────╯")
    print(f" {PL}╭────────────────────────────────────────────────────────────────────────╮")                   
    print(f" {PL}│           {PL} 𝗖 𝗢 𝗠 𝗠 𝗘 𝗡 𝗧 𝗦  & 𝗙 𝗢 𝗟 𝗟 𝗢 𝗪   𝗕 𝗢 𝗢 𝗦 𝗧 𝗜 𝗡 𝗚           {PL} │")
    print(f" {PL}╰────────────────────────────────────────────────────────────────────────╯ """)
    print(f"    {PL}╭───────────────────────╮")
    print(f"    {PL}│   {BG1} {A} FOLLOWER V1  {RW}     {PL}│──── [{BG2}{A} 07/G {RW}]──── {red}◉ {yellow}◉ {green}◉  {Q6} PAGE OR ACCOUNT ")
    print(f"    {PL}╰───────────────────────╯")
    print(f"    {PL}╭───────────────────────╮")
    print(f"    {PL}│   {BG1} {A} FOLLOWER V2{RW}{PL}       │──── [{BG2}{A} 08/H {RW}]──── {red}◉ {yellow}◉ {green}◉  {Q6} PAGE OR ACCOUNT ")
    print(f"   {PL} ╰───────────────────────╯")
    print(f"    {PL}╭───────────────────────╮")
    print(f"   {PL} │   {BG1} {A} CUSTOM COMMENT  {RW}  {PL}│──── [{BG2}{A} 09/I {RW}]──── {red}◉ {yellow}◉ {green}◉  {Q6} PAGE OR ACCOUNT ")
    print(f"    {PL}╰───────────────────────╯")
    print(f" {PL}╭────────────────────────────────────────────────────────────────────────╮")                   
    print(f" {PL}│           {PL}    𝗘 𝗡 𝗧 𝗘 𝗥   𝗬 𝗢 𝗨 𝗥  𝗖 𝗛 𝗢 𝗜 𝗖 𝗘   𝗛 𝗘 𝗥 𝗘               {PL} │")
    print(f" {PL}╰────────────────────────────────────────────────────────────────────────╯ """)
    
    choice = input(f"      {BG2} {A} CHOICES {RW} {green}: {Z1} ").strip() 
#C:\Users\Dont touch my pc\Desktop\OPENSOURCE\sy.py
    ...
    if choice == '7' or choice == 'G':
        auto_follow_fast()
    if choice == '8' or choice == 'H':
        perform_actions_from_file()
    if choice == '9' or choice == 'I':
        live_comment()
